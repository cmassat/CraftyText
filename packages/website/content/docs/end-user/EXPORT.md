...
CraftyText allows you to export a markdown document as PDF and HTML file or to print the document.
...
CraftyText allows you to select a page theme before exporting. You can learn more about page themes [here](EXPORT_THEMES.md).
...
![](../assets/craftytext-export-header.png)

![](../assets/craftytext-export-pdf.png)
