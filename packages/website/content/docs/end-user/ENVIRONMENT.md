...
| `CRAFTYTEXT_PANDOC`            | Overwrite the pandoc path.                                  |
| `CRAFTYTEXT_RIPGREP_PATH`      | Overwrite the bundled ripgrep path.                         |
...
The old `MARKTEXT_*` names are still accepted as compatibility aliases.
