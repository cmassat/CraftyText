...
```markdown
![Alt text](/assets/logo.png "CraftyText logo")
```
...
[id]: /assets/logo.png  "CraftyText logo"
...
**NOTE:** CraftyText provides an emoji picker with search functionality.
...
CraftyText support class, flow chart, gantt and sequence diagrams powered by flowchart.js, mermaid and Vega-Lite. [Code](#code) blocks with special language identifiers are used for diagrams.
