      ...
      <div className="wrap">
        ...
        <div className={revealClass('d2', 'stage')} id="stage" ref={stageRef}>
          ...
          <MockWindow title="product-launch.md" showActions windowId="heroWin" windowRef={winRef}>
            ...
            <p className="lead">
              CraftyText renders your formatting <strong>as you type</strong> — headings grow, <em>emphasis</em> leans, and{' '}
            ...
            <blockquote>“The best Markdown editors disappear. CraftyText disappears beautifully.”</blockquote>
            <pre>
              <span className="c">{'# export.sh'}</span>
              {'\n'}
              <span className="k">craftytext</span> notes.md <span className="f">--export</span>{' '}
