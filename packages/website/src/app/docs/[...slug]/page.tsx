...
export default async function DocPage({ params }: { params: Promise<Params> }) {
  ...
  const editHref = DOWNLOAD.repo + '/edit/main/packages/website/content/docs/' + page.file
      ...
      <main className="doc-main">
        ...
        <article className="doc-article">
          ...
          <footer className="doc-footer">
            <span>Last reviewed in the main branch · open source under the MIT license.</span>
