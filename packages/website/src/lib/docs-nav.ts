    ...
    groups: [
      {
        ...
        pages: [
          ...
          },
          {
            slug: ['linux'],
            title: 'Linux notes',
            file: 'end-user/LINUX.md',
            hint: 'Distro-specific install tips & quirks'
          },
          {
            slug: ['basics'],
            title: 'Basics',
          ...
          },
          {
            ...
            hint: 'Every element CraftyText renders'
          }
        ]
      },
      {
        ...
        pages: [
          ...
          {
            slug: ['key-bindings-linux'],
            title: 'Key bindings (Linux)',
            file: 'end-user/KEYBINDINGS_LINUX.md',
            hint: 'Default shortcuts on Linux'
          },
          {
          ...
          },
          {
            ...
            hint: 'Where CraftyText stores user data'
          },
          {
      ...
      },
      {
        ...
        pages: [
          ...
          },
          {
            slug: ['images'],
            title: 'Image support',
            file: 'end-user/IMAGES.md',
            hint: 'Copy images to a local folder'
          },
          {
            slug: ['image-uploader'],
        ...
        pages: [
          {
            ...
            hint: 'Run CraftyText from a USB stick'
          },
          {
            slug: ['faq'],
            title: 'FAQ',
    ...
    groups: [
      {
        ...
        pages: [
          ...
          },
          {
            ...
            file: 'dev/BUILD.md',
            hint: 'Build CraftyText from source'
          },
          {
            slug: ['dev', 'linux-dev'],
