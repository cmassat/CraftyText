...
<h2 align="center">CraftyText'e Destek Olun</h2>

CraftyText, topluluğunun desteğiyle hayata geçirilmiş açık kaynaklı bir Markdown editörüdür. CraftyText iş akışınızı iyileştiriyorsa, lütfen [projeye destek olmayı](https://github.com/cmassat/craftytext) düşünün. Tüm destekçilere teşekkürler ❤️

**Özel Destekçi**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=craftytext) | [Hızlı, kolay ve kapsamlı API'miz ile Google ve diğer arama motorlarından veri çekin.](https://serpapi.com/?utm_source=craftytext) |
| ------------- |:-------------|
...
[Sürümler sayfasından](https://github.com/cmassat/craftytext/releases/latest) en son `craftytext-%version%.dmg`'yi indirebilir veya [**homebrew cask**](https://github.com/caskroom/homebrew-cask) kullanarak CraftyText'i kurabilirsiniz. Homebrew-Cask kullanmak için [Homebrew](https://brew.sh/)'ün yüklü olması gerekir.
...
CraftyText'i kurulum sihirbazı (`craftytext-setup-%version%.exe`) aracılığıyla indirip kurun ve kullanıcı başına mı yoksa sistem genelinde mi kurulacağını seçin. Alternatif olarak [Chocolatey](https://chocolatey.org/) veya [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) gibi bir paket yöneticisi kullanabilirsiniz.
...
Linux, macOS ve Windows için tüm ikili dosyalar [sürümler sayfasından](https://github.com/cmassat/craftytext/releases/latest) indirilebilir. Sisteminiz için bir sürüm mevcut değilse lütfen bir [issue](https://github.com/cmassat/craftytext/issues) açın.

## Geliştirme

CraftyText'i kendiniz derlemek istiyorsanız lütfen [derleme talimatlarımıza](../dev/BUILD.md) bakın.

- [Kullanıcı belgeleri](../README.md)
- [Geliştirici belgeleri](../dev/README.md)

CraftyText hakkında sorularınız varsa bir issue yazabilirsiniz. Bunu yaparken issue açarken görünen varsayılan formatı kullanın. Elbette doğrudan bir PR gönderirseniz çok memnun oluruz.

## Katkı

CraftyText geliştirme aşamasındadır. Bir pull request oluşturmadan önce [Katkı Kılavuzunu](../../.github/CONTRIBUTING.md) okuduğunuzdan emin olun. CraftyText'e özellik eklemek ister misiniz? [Yol haritamıza](https://github.com/cmassat/craftytext/projects) ve açık issue'lara bakın.


## Katkıda Bulunanlar

CraftyText'e zaten katkıda bulunan herkese teşekkür ederiz[[katkıda bulunanlar](https://github.com/cmassat/craftytext/graphs/contributors)].
