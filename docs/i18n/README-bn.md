...
<div align="center">
  ...
  একটি সাধারণ এবং অত্যাধুনিক ওপেন-সোর্স Markdown এডিটর যা গতি এবং ব্যবহারযোগ্যতার দিকে গুরুত্ত দেয়।<br>
...
<div align="center">
  ...
  <a href="https://github.com/cmassat/craftytext/releases/latest">
    <img src="https://img.shields.io/github/downloads/cmassat/craftytext/latest/total.svg" alt="latest download">
  </a>
  <!-- sponsors -->
...
<div align="center">
  <sub>এই Markdown এডিটরটি ❤︎ দিয়ে তৈরি করেছেন
    <a href="https://github.com/Jocs">Jocs</a> এবং
...
CraftyText একটি ওপেন-সোর্স Markdown এডিটর, যা এর কমিউনিটির সহায়তায় এগিয়ে চলছে। CraftyText যদি আপনার কাজের ধারা উন্নত করে থাকে, তাহলে অনুগ্রহ করে [প্রজেক্টটিকে স্পনসর করার](https://github.com/cmassat/craftytext) কথা বিবেচনা করুন। সব স্পনসরকে ধন্যবাদ ❤️

**বিশেষ স্পনসর**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=craftytext) | [আমাদের দ্রুত, সহজ এবং পূর্ণাঙ্গ API দিয়ে Google ও অন্যান্য সার্চ ইঞ্জিন থেকে ফলাফল সংগ্রহ করুন।](https://serpapi.com/?utm_source=craftytext) |
| ---------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------- |
...
- বিভিন্ন [theme](https://github.com/cmassat/craftytext/docs/themes): **Cadmium Light**, **Material Dark** ইত্যাদি।
...
| :------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------: |
| [![Download for macOS](https://img.shields.io/badge/macOS-Download-blue)](https://github.com/cmassat/craftytext/releases/latest) | [![Download for Windows](https://img.shields.io/badge/Windows-Download-blue)](https://github.com/cmassat/craftytext/releases/latest) | [![Download for Linux](https://img.shields.io/badge/Linux-Download-blue)](https://github.com/cmassat/craftytext/releases/latest) |

সর্বশেষ সংস্করণের নতুন ফিচারগুলো দেখতে [CHANGELOG](https://github.com/cmassat/craftytext/docs/changelog) দেখুন।
...
আপনি [release page](https://github.com/cmassat/craftytext/releases/latest) থেকে সর্বশেষ `craftytext-mac-(arm64|x64)-%version%.dmg` ডাউনলোড করতে পারেন, অথবা [**homebrew cask**](https://github.com/caskroom/homebrew-cask) ব্যবহার করে CraftyText ইনস্টল করতে পারেন। Homebrew-Cask ব্যবহার করতে হলে আগে [Homebrew](https://brew.sh/) ইনস্টল করা থাকতে হবে।
...
শুধু setup wizard (`craftytext-win-(x64|arm64)-%version%-setup.exe`) ডাউনলোড করে ইনস্টল করুন এবং user-only নাকি machine-wide ইনস্টল করবেন তা বেছে নিন। বিকল্পভাবে, [Chocolatey](https://chocolatey.org/) বা [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) এর মতো package manager ব্যবহার করেও CraftyText ইনস্টল করতে পারেন।
...
Winget ব্যবহার করতে চাইলে আগে [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/#install-winget) ইনস্টল করা থাকতে হবে:
...
অনুগ্রহ করে [Linux installation instructions](https://github.com/cmassat/craftytext/docs/installation) অনুসরণ করুন।

#### অন্যান্য

Linux, macOS এবং Windows-এর সব binary [release page](https://github.com/cmassat/craftytext/releases/latest) থেকে ডাউনলোড করা যাবে। আপনার সিস্টেমের জন্য কোনো সংস্করণ না থাকলে একটি [issue](https://github.com/cmassat/craftytext/issues) খুলুন।

## ডেভেলপমেন্ট

আপনি যদি নিজে CraftyText build করতে চান, তাহলে আমাদের [build instructions](https://github.com/cmassat/craftytext/docs/dev/build) দেখুন।

- [ব্যবহারকারী ডকুমেন্টেশন](https://github.com/cmassat/craftytext/docs/introduction)
- [ডেভেলপার ডকুমেন্টেশন](https://github.com/cmassat/craftytext/docs/dev/overview)

CraftyText সম্পর্কে আপনার কোনো প্রশ্ন থাকলে issue খুলতে পারেন। Issue খোলার সময় অনুগ্রহ করে ডিফল্ট ফরম্যাটটি ব্যবহার করুন। অবশ্যই, সরাসরি PR পাঠালে সেটিও অত্যন্ত প্রশংসিত হবে।

## অবদান

CraftyText এখনো উন্নয়নাধীন, তাই pull request করার আগে [Contributing Guide](../../.github/CONTRIBUTING.md) পড়ে নিন। CraftyText-এ নতুন ফিচার যোগ করতে চান? আমাদের [roadmap](https://github.com/cmassat/craftytext/projects) এবং open issue দেখুন।

## অবদানকারীরা

যারা ইতিমধ্যেই CraftyText-এ অবদান রেখেছেন, তাদের সবাইকে ধন্যবাদ [[contributors](https://github.com/cmassat/craftytext/graphs/contributors)]।
