...
<h2 align="center">Apoiando o CraftyText</h2>

CraftyText é um editor Markdown de código aberto impulsionado pelo apoio de sua comunidade. Se o CraftyText melhora seu fluxo de trabalho, considere [patrocinar o projeto](https://github.com/cmassat/craftytext). Obrigado a todos os patrocinadores ❤️

**Patrocinador Especial**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=craftytext) | [Extraia dados do Google e de outros mecanismos de busca com nossa API rápida, fácil e completa.](https://serpapi.com/?utm_source=craftytext) |
| ---------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------- |
...
Você pode baixar o último `craftytext-%version%.dmg` da [página de releases](https://github.com/cmassat/craftytext/releases/latest) ou instalar o CraftyText usando o [**homebrew cask**](https://github.com/caskroom/homebrew-cask). Para usar o Homebrew-Cask você só precisa ter o [Homebrew](https://brew.sh/) instalado.
...
Simplesmente baixe e instale o CraftyText via assistente de configuração (`craftytext-setup-%version%.exe`) e escolha instalar por usuário ou para toda a máquina. Alternativamente, instale o CraftyText usando um gerenciador de pacotes como [Chocolatey](https://chocolatey.org/) ou [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/).
...
Todos os binários para Linux, macOS e Windows podem ser baixados da [página de releases](https://github.com/cmassat/craftytext/releases/latest). Se uma versão não estiver disponível para o seu sistema, por favor abra um [issue](https://github.com/cmassat/craftytext/issues).

## Desenvolvimento

Se você deseja compilar o CraftyText, por favor consulte nossas [instruções de compilação](../dev/BUILD.md).

- [Documentação do usuário](../README.md)
- [Documentação do desenvolvedor](../dev/README.md)

Se você tiver alguma dúvida sobre o CraftyText, fique à vontade para abrir um issue. Ao fazê-lo, use o formato padrão encontrado ao abrir um issue. Claro, se você enviar um PR diretamente, será muito apreciado.

## Contribuição

CraftyText está em desenvolvimento. Por favor leia o [Guia de Contribuição](../../.github/CONTRIBUTING.md) antes de fazer um pull request. Quer adicionar recursos ao CraftyText? Consulte nosso [roadmap](https://github.com/cmassat/craftytext/projects) e issues abertas.

## Colaboradores

Obrigado a todas as pessoas que já contribuíram para o CraftyText[[colaboradores](https://github.com/cmassat/craftytext/graphs/contributors)].
