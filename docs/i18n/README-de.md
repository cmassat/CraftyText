...
<h2 align="center">CraftyText unterstützen</h2>

CraftyText ist ein Open-Source-Markdown-Editor, der von seiner Community unterstützt wird. Wenn CraftyText Ihren Workflow verbessert, erwägen Sie bitte, [das Projekt zu sponsern](https://github.com/cmassat/craftytext). Vielen Dank an alle Sponsoren ❤️

**Besonderer Sponsor**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=craftytext) | [Extrahieren Sie Daten von Google und anderen Suchmaschinen über unsere schnelle, einfache und vollständige API.](https://serpapi.com/?utm_source=craftytext) |
| ---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
Du kannst entweder die neueste `craftytext-%version%.dmg` von der [Release-Seite](https://github.com/cmassat/craftytext/releases/latest) herunterladen oder CraftyText über [**homebrew cask**](https://github.com/caskroom/homebrew-cask) installieren. Für Homebrew-Cask muss [Homebrew](https://brew.sh/) installiert sein.
...
Lade CraftyText einfach über den Setup-Assistenten (`craftytext-setup-%version%.exe`) herunter und installiere es, wähle dabei zwischen Benutzer- oder systemweiter Installation. Alternativ kann CraftyText über einen Paketmanager wie [Chocolatey](https://chocolatey.org/) oder [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) installiert werden.
...
Alle Binärdateien für Linux, macOS und Windows können von der [Release-Seite](https://github.com/cmassat/craftytext/releases/latest) heruntergeladen werden. Falls keine Version für dein System verfügbar ist, öffne bitte ein [Issue](https://github.com/cmassat/craftytext/issues).

## Entwicklung

Wenn du CraftyText selbst erstellen möchtest, sieh dir bitte unsere [Build-Anleitung](../dev/BUILD.md) an.

- [Benutzerdokumentation](../README.md)
- [Entwicklerdokumentation](../dev/README.md)

Bei Fragen zu CraftyText kannst du gerne ein Issue erstellen. Bitte verwende dabei das Standardformat. Natürlich ist auch ein direkter PR sehr willkommen.

## Beitrag

CraftyText befindet sich in der Entwicklung. Bitte lies den [Beitragsleitfaden](../../.github/CONTRIBUTING.md) vor dem Erstellen eines Pull Requests. Möchtest du Funktionen zu CraftyText hinzufügen? Sieh dir unsere [Roadmap](https://github.com/cmassat/craftytext/projects) und offene Issues an.

## Mitwirkende

Danke an alle, die bereits zu CraftyText beigetragen haben[[Mitwirkende](https://github.com/cmassat/craftytext/graphs/contributors)].
